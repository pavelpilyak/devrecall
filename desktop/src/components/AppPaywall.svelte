...
<div class="flex flex-col items-center justify-center h-full p-8">
  <div class="max-w-sm text-center space-y-5">
    ...
    <h2 class="text-xl font-semibold">DevRecall Desktop requires a license</h2>
    <p class="text-sm text-zinc-600 dark:text-zinc-400">
      The desktop app is available on the Pro and Team plans.
      The CLI remains free for basic Git standups.
    </p>

    <div class="text-sm text-zinc-600 dark:text-zinc-400 text-left space-y-1">
      <p class="font-medium">Pro plan includes:</p>
      <ul class="list-disc list-inside space-y-0.5">
        <li>Desktop app with AI chat</li>
        <li>All integrations (Slack, Calendar, GitHub, Jira, Linear)</li>
        <li>AI-powered standups & weekly summaries</li>
    ...
    <p class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
      $99 one-time purchase &middot; 1 device
    </p>
    ...
    <div class="flex gap-2 justify-center">
      ...
      >
        {showActivate ? "Cancel" : "I have a key"}
      </button>
    </div>
